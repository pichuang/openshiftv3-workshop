...
Please make sure you have completed Lab 2 exercise - link:2-Create-App-Using-Docker-Build.adoc[Create an application using Docker Build Strategy using CLI]

*Step 1: Switch to an existing project*

For this exercise, we will be using an already running application. We
will be using the `lab2` that you created in the
