...
....
$ oc new-project lab4 --display-name="My JBoss Applications" --description="A place for my JBoss EAP Applications"
....
...
https://github.com/pichuang/kitchensink[here]). Taking that
...
Git Repository URL: https://github.com/pichuang/kitchensink
