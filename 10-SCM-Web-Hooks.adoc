...
....
$ oc new-project lab10 --display-name="Test WebHooks"
....

*Step 2: Create new application*

* We will use the forked repository from the previous lab.
link:https://github.com/RedHatWorkshops/bluegreen[Forked from RedHat Workshops/bluegreen]
...
$ oc logs build/scm-web-hooks-<NUMBER>
....
