...
*lab5*. Replace by your username to make this project
...
****
Add to Project: lab5 (this should be the same project as MySQL Ephemeral)
...
Pushing image docker-registry.default.svc:5000/lab5/pricelist:latest ...
...
....
$ oc project
Using project "lab5" on server "{{CONSOLE_ADDRESS}}".
...
pricelist   pricelist-lab5.apps.workshop.osecloud.com 	                   pricelist   8080-tcp                 None
....
